var _createClass = function () {function defineProperties(target, props) {for (var i = 0; i < props.length; i++) {var descriptor = props[i];descriptor.enumerable = descriptor.enumerable || false;descriptor.configurable = true;if ("value" in descriptor) descriptor.writable = true;Object.defineProperty(target, descriptor.key, descriptor);}}return function (Constructor, protoProps, staticProps) {if (protoProps) defineProperties(Constructor.prototype, protoProps);if (staticProps) defineProperties(Constructor, staticProps);return Constructor;};}();function _classCallCheck(instance, Constructor) {if (!(instance instanceof Constructor)) {throw new TypeError("Cannot call a class as a function");}} /*
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        ...
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        */
function lerp(_ref, _ref2) {var x = _ref.x,y = _ref.y;var targetX = _ref2.x,targetY = _ref2.y;
  var fraction = 0.1;
...
Slider = function () {
  function Slider(el) {_classCallCheck(this, Slider);
  ...
  }_createClass(Slider, [{ key: 'onResize', value: function onResize()
    {
      var htmlStyles = getComputedStyle(document.documentElement);
      var mobileBreakpoint = htmlStyles.getPropertyValue('--mobile-bkp');

      var isMobile = this.isMobile = matchMedia('only screen and (max-width: ' +
      mobileBreakpoint + ')').
      matches;
    ...
    } }, { key: 'getMouseCoefficients', value: function getMouseCoefficients()
    {var _ref3 = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {},pageX = _ref3.pageX,pageY = _ref3.pageY;
    ...
    } }, { key: 'onMouseMove', value: function onMouseMove(_ref4)
    {var pageX = _ref4.pageX,pageY = _ref4.pageY;
      this.targetX = pageX;
      this.targetY = pageY;
    ...
    } }, { key: 'runAnimation', value: function runAnimation()
    {
      ...
      {
        x: this.targetX,
        y: this.targetY });var _getMouseCoefficients =


      this.getMouseCoefficients({
        pageX: newPos.x,
        pageY: newPos.y }),xCoeff = _getMouseCoefficients.xCoeff,yCoeff = _getMouseCoefficients.yCoeff;
    ...
    } }, { key: 'positionImage', value: function positionImage(_ref5)
    ...
    {var xCoeff = _ref5.xCoeff,yCoeff = _ref5.yCoeff;
      var maxImgOffset = 1;
      var currentImage = this.activeImg[0].children[0];

      currentImage.style.setProperty('transform', '\n      translateX(' +
      maxImgOffset * -xCoeff + 'em)\n      translateY(' +
      maxImgOffset * yCoeff + 'em)\n    ');

    } }, { key: 'onDotClick', value: function onDotClick(_ref6)
    ...
    } }, { key: 'transitionItem', value: function transitionItem(
    nextId) {var _this = this;
    ...
    } }, { key: 'prev', value: function prev()
    {
      ...
      this.startTransition(nextId);
    } }, { key: 'switchBackgroundImage', value: function switchBackgroundImage(
    nextId) {
    ...
    } }, { key: 'reachedFinalPoint', get: function get() {var lastX = ~~this.lastX;var lastY = ~~this.lastY;var targetX = this.targetX;var targetY = this.targetY;return (lastX == targetX || lastX - 1 == targetX || lastX + 1 == targetX) && (lastY == targetY || lastY - 1 == targetY || lastY + 1 == targetY);} }]);return Slider;}();
